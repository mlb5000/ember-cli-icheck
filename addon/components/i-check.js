...
export default Checkbox.extend({
  ...
  didInsertElement() {
    ...
    var icheck = $().iCheck({
      ...
      indeterminateClass: this.getWithDefault(
        "indeterminateClass",
        "indeterminate"
      ),
      // if not empty, used instead of 'indeterminateClass' option (input type specific)
      indeterminateCheckboxClass: this.getWithDefault(
        "indeterminateCheckboxClass",
        ""
      ),
      indeterminateRadioClass: this.getWithDefault(
      ...
      determinateCheckboxClass: this.getWithDefault(
